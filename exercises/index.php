                ...
                <div class="row h-100">
                    <div class="col-12 h-100">
                        <nav class="h-100 navbar navbar-expand-lg">
                            <a class="navbar-brand" href="index.html"><img src="img/core-img/logo1.png" alt=""></a>
    ...
    <div id="id01" class="modal">
				...
				<form class="modal-content" id="myForm1" action="/bouncer.php"><!-- tbd-->
                    <div class="container">
						...
						<input type="text" placeholder="Enter Email" name="email" onfocus="showDesc('parapostal');" required>
                            ...
                            <div class="tab-pane fade show active" id="nav-places" role="tabpanel" aria-labelledby="nav-places-tab">
                                ...
                                <form action="searchResults.html" method="get">
                                    ...
                                    <select class="custom-select">
                                        ...
                                        <option value="3">$10,000 - and more</option>
                                    </select>
...
Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | This template is made with <i class="fa fa-heart-o" aria-hidden="true"></i> by <a href="index.html" target="_blank">Travel Experts team</a>
