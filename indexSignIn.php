                        ...
                        <nav class="h-100 navbar navbar-expand-lg">
                            ...
                            <div class="collapse navbar-collapse" id="dorneNav">
                                ...
                                <div class="dorne-signin-btn">
                                    <a style="color: #fff;">Agent: <?php  print($_GET["email"]);  ?></a>
                                </div>
                                <!-- Add listings btn-->
            ...
            <div class="row h-100 align-items-center justify-content-center">
                <div class="col-12 col-md-10">
                    <div class="hero-content">
                        <h3><label id="lblGreetings"></label></h3>
                        <h4>This page can be just used by the user: <?php  print($_GET["email"]);  ?></h4>
                    </div>
                    <!-- Hero Search Form -->
                        ...
                        <div class="tab-content" id="nav-tabContent">
                            <div class="tab-pane fade show active" id="nav-places" role="tabpanel" aria-labelledby="nav-places-tab">
                                ...
                                <form action="/searchResultsAgent.php" method="get">
                                    <select hidden name="agentEmail"><option selected><?php  print($_GET["email"]);  ?></option></select>
                                    ...
                                    <select class="custom-select" name="custom-select3">
                                        ...
                                        <option value="10000">$10,000 - and more</option>
                                    </select>
