...
<body>
    ...
    <section class="container">
      <h2>Our Agents: </h2>
      <p>Our agents are always ready for your help and they are all  Experts!</p>
               ...
               <?php
                       ...
                       if (! $dbh)
                       {
                         die("Error: " . mysqli_connect_errno() . " - " . mysqli_connect_error());
                           ...
                           $sql = "SELECT AgtFirstName,AgtLastName,AgtBusPhone,AgtEmail,AgtPosition,AgencyId FROM agents";
